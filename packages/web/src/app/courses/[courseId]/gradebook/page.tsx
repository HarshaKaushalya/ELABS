...
import { GradebookTable } from "@/components/courses/GradebookTable";
...
export default async function Page({ params }: PageProps) {
  ...
  return (
    <AppShell title="Course Gradebook" subtitle={`Course ID: ${courseId}`}>
      <section className="panel" style={{ marginBottom: 12 }}>
        <div className="tab-row">
          ...
          <Link className="tab-btn active" href={`/courses/${courseId}/gradebook`}>Gradebook</Link>
